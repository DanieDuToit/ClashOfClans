...
(function ($) {
    ...
    $.fn.slider = function (_3e, _3f) {
        ...
        return this.each(function () {
            ...
            if (_40) {
                ...
                _40 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _3e),
                    slider: _1(this)
                });
    ...
    $.fn.slider.parseOptions = function (_47) {
        var t = $(_47);
        return $.extend({}, $.parser.parseOptions(_47, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_48) {
            return _48;
        },
        converter: {
            toPosition: function (_49, _4a) {
